 ...
 * @author joel_
 */
public class FormularioEditarServicios extends javax.swing.JFrame {
    
    private ServicioAdmin servicioAdmin;
    private CitaAdmin citaAdmin;
    private Conexion CONEXION;
    
    public FormularioEditarServicios() {
        inicializarFlatLaf();
        ...
        try {
            ...
            Logger.getLogger(FormularioEditarServicios.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void actualizarServiciosComboBox() throws SQLException {
        servicioAdmin.obtenerLista();
        comboBoxServiciosAgenda.removeAllItems();
    ...
    private void initComponents() {
        ...
        jLabel23.setText("Editar Servicio");
        ...
        panel_Round_JWC11.setBackground(new java.awt.Color(255, 204, 51));
        ...
        btnGuardar.setBackground_Hover_1(new java.awt.Color(169, 127, 3));
        btnGuardar.setBackground_Hover_2(new java.awt.Color(255, 204, 51));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (verificarCamposVacios(textNombre, textPrecio) && esSoloDigitosPrecio(textPrecio.getText())) {
            ...
            try {
                servicioAdmin.leerServicios();
                int idServicio = servicioAdmin.obtenerID(tablaServicios.getValueAt(tablaServicios.getSelectedRow(), 0).toString());
                
                comboBoxServiciosAgenda.removeItem(idServicio);
                
                if (servicioAdmin.editarServicio(idServicio, textNombre.getText(), Double.parseDouble(textPrecio.getText().trim()),
                        Integer.parseInt(textMinutos.getValue().toString().trim()))) {
                    JOptionPane.showMessageDialog(null, "Servicio modificado con exito");
                    this.dispose();
                    
                    actualizarTablaServicios();
                    actualizarTablaCitas();
                    actualizarServiciosComboBox();
    ...
    public javax.swing.JSpinner textMinutos;
